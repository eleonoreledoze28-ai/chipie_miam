  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.summarySection}>
        ...
        {/* Mini-game card */}
        <button className={styles.gameCard} onClick={() => navigate('/jeu')}>
          <div className={styles.gameLeft}>
            <span className={styles.gameEmoji}>🎮</span>
            <div>
              <span className={styles.gameTitle}>Devinette Photo</span>
              <span className={styles.gameDesc}>Reconnaissez-vous ces végétaux ?</span>
            </div>
          </div>
